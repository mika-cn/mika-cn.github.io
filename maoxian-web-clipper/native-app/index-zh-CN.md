...
**致歉**：本次 MaoXian 扩展的更新（0.1.46），无法兼容老版本的「本地程序」，所以当扩展更新后，使用「本地程序」的老用户，需要升级到新版本，才能继续使用。此实属无奈之举，造成诸多不便，非常抱歉。
...
为了更方便地预览裁剪下来的文件，我们强烈建议你 **[允许 MaoXian 访问本地网址](../faq-zh-CN.html#allow-access-file-urls)**，以便可以方便地查看裁剪下来的文件。
